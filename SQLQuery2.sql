...
DROP TABLE IF EXISTS SAIDAPRODUTOS
DROP TABLE IF EXISTS ENTRADAPRODUTOSDETALHES
DROP TABLE IF EXISTS SAIDAPRODUTOSDETALHES
...
(
ENTRADAPRODUTO_ID INT NOT NULL REFERENCES ENTRADAPRODUTOS(ID),
PRODUTO INT NOT NULL REFERENCES PRODUTOS(ID),
...
(
SAIDAPRODUTO INT NOT NULL REFERENCES SAIDAPRODUTOS(ID),
PRODUTO_ID INT NOT NULL REFERENCES PRODUTOS,
FORNECEDOR_ID int FOREIGN KEY REFERENCES FORNECEDORES(ID) NOT NULL,
QUANTIDADE INT NOT NULL,
VALOR_UNITARIO FLOAT NOT NULL,
PRIMARY KEY (SAIDAPRODUTO, PRODUTO)
)
